...
export default function PopularTeacher() {
    ...
    useEffect(() => {
        axiosFetch.get('/popular_instructors')
            .then((data) => {
    ...
    return (
        <div className='md:w-[80%] mx-auto my-36'>
            ...
            <div className='w=[40%] text-center mx-auto my-4'>
                <p className='text-gray-500'>Explore Our Amazing Teachers. Here are some Top Tier Instructors.</p>
            </div>

            {instructors.length > 0 ? (
                <div className='grid mb-2 md:grid-cols-2 lg:grid-cols-4 w-[90%] gap-4 mx-auto'>
                        ...
                        <div key={i} className='flex dark:text-white hover:-translate-y-2 duration-200 cursor-pointer flex-col shadow-md py-8 px-10 md:px-8 rounded-md'>
                            <div className='flex-col flex gap-6 md:gap-8'>
                                ...
                                <div className='flex flex-col text-center'>
                                    ...
                                    <p className='text-gray-500 mb-4 whitespace-nowrap'>Total Student: {Instructor?.totalEnrolled}</p>
                                </div>
                            </div>
                        </div>
                    ))}
